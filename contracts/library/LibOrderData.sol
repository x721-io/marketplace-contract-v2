...
library LibOrderData {
    ...
    // ) internal pure returns (GenericOrderData memory dataOrder) {
    //     dataOrder.protocolFeeEnabled = false;
    //     if (order.dataType == LibOrderDataV1.V1) {
    //         LibOrderDataV1.DataV1 memory data = abi.decode(
    //             order.data,
    //             (LibOrderDataV1.DataV1)
    //         );
    //         dataOrder.payouts = data.payouts;
    //         dataOrder.originFees = data.originFees;
    //     } else if (order.dataType == LibOrderDataV2.V2) {
    //         LibOrderDataV2.DataV2 memory data = abi.decode(
    //             order.data,
    //             (LibOrderDataV2.DataV2)
    //         );
    //         dataOrder.payouts = data.payouts;
    //         dataOrder.originFees = data.originFees;
    //         dataOrder.isMakeFill = data.isMakeFill;
    //     } else if (order.dataType == LibOrderDataV3.V3) {
    //         LibOrderDataV3.DataV3 memory data = abi.decode(
    //             order.data,
    //             (LibOrderDataV3.DataV3)
    //         );
    //         dataOrder.payouts = data.payouts;
    //         dataOrder.originFees = data.originFees;
    //         dataOrder.isMakeFill = data.isMakeFill;
    ...
    function parseOriginFeeData(uint256 dataFirst, uint256 dataSecond)
        internal
        pure
        returns (LibPart.Part[] memory)
    {
